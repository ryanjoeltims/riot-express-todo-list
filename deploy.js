...
function transferProjectToRemote(failed, successful) {
  return ssh.putDirectory(
    ...
    '/home/ubuntu/riot-todo-list-temp',
    {
      recursive: true,
      concurrency: 1,
...
function createRemoteTempFolder() {
  return ssh.execCommand(
    'rm -rf riot-todo-list-temp && mkdir riot-todo-list-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function updateRemoteApp() {
  return ssh.execCommand(
    'cp -r riot-todo-list-temp/* riot-todo-list/ && rm -rf riot-todo-list-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function restartRemoteServices() {
  return ssh.execCommand(
    'cd riot-todo-list && sudo service mongod start && pm2 start app.js', {
      cwd: '/home/ubuntu'
  });
}
...
function sshConnect() {
  ...
  ssh
    ...
    .then(function() {
      console.log('Creating `riot-todo-list-temp` folder.');
